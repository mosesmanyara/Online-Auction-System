<?php 
    ...
    if(isset($_POST['update'])) {
        ...
        if(! $errCount) {
            $query = "UPDATE admin SET address='$address', city='$city', country='$country', country_code='$countryCode' WHERE user_id='$id' ";
    ...
    <main class="container">
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="address" name="address" placeholder="ex: 00200-00100 Nairobi" value="<?php echo $address; ?>" required>

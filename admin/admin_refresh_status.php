...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-between py-0 px-3 mb-5">
        ...
        <div class="navbar-nav h5">
            ...
            <a class="nav-item nav-link mr-3 active" href="admin_refresh_status.php"><i class="fas fa-sync-alt"></i> Refresh Status</a>
        </div>
        <div class="navbar-nav h5">
    ...
    <main class="row">
        ...
        <div class="col-md-9">
            <h4>New Updated Items</h4>
            <hr />
            <?php include('admin_includes/admin_refresh_updated.php'); ?>      
            <br />

            <h4>Recently Closed Items</h4>
            <hr />
            <?php include('admin_includes/admin_refresh_recent.php'); ?> 
        </div>
    </main>
